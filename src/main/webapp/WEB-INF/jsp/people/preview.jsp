		...
		<div class="container">
		    <div class="row">
		        <div class="span8 offset2">
		            ...
		            <form:form method="post" action="people/add" commandName="person" class="form-vertical" id="personForm">
		                ...
		                <input type="submit" value="Add Person" class="btn" data-id="person"/>
		            </form:form>
