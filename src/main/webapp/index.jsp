			...
			<div class="span8 offset2">
				...
				<div class="tabbable">
					<ul id="tab" class="nav nav-tabs">
						<li class="active"><a href="#eclipse-instructions"
							data-toggle="tab">Use Eclipse 3.7</a></li>
						<li><a href="#cli-instructions" data-toggle="tab">Use
								Command Line</a></li>
					</ul>
					...
					<div class="tab-content">
						...
						<div id="eclipse-instructions"
							class="instructions tab-pane active">
								...
								<li>Click <code>Login</code>. If your login was successful,
									...
									<div class="modal hide" id="apiPreferences">
										...
										data-toggle="modal"> <img
											src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/heroku_preferences.png'
											alt="setup api key" width="100"> <i
											class="icon-zoom-in"></i>
									</a>
								</span>
								</li>
								<li>In the SSH Key section, click <code>Generate</code> if
									you need to generate a new key. If you have previously
									generated and saved a SSH key is automatically loaded from the
									default location. If it is not in the default location, click <code>Load
										SSH Key</code><br />
								</li>
							...
							<ol>
								...
								<li>Select <code>Existing Heroku Application</code><i
									class="icon-chevron-right"></i> <code>Next</code></li>
								<li>Select <code>
										<script>
							...
							<ol>
								...
								<li>Query the people in alphabetical order by replacing
									line 29 with the following two lines: <pre
										class="once language-java">
...
c.orderBy(em.getCriteriaBuilder().asc(from.get("lastName")));
							...
							<ol>
								...
								<li>Right-click the project root and choose <code>Team</code>
									<i class="icon-chevron-right"></i> <code>Push to
										Upstream</code></li>
							...
							<div class="hero-unit">
								...
								<p>You've just cloned, modified, and deployed a brand new
									app.</p>
								<a href="/people/" class="btn btn-primary btn-large">See
									your changes</a>
...
Authentication successful.</pre>
							...
							<ol>
								<li>Open <code>src/main/java/com/example/PersonServiceImpl.java
										in your favorite editor</code></li>
								<li>Query the people in alphabetical order by replacing
									line 29 with the following two lines: <pre
										class="once language-java">
Root&lt;Person&gt; from = c.from(Person.class);
